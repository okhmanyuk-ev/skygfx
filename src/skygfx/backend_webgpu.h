...
namespace skygfx
{
	class BackendWebGPU : public Backend
	{
	public:
		BackendWebGPU(void* window, uint32_t width, uint32_t height, Adapter adapter);
		~BackendWebGPU();
		...
		void writeTexturePixels(TextureHandle* handle, uint32_t width, uint32_t height, Format format, const void* memory,
